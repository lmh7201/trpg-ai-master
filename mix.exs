defmodule TrpgMaster.MixProject do
  ...
  defp deps do
    [
      # Core Phoenix — versions compatible with Elixir 1.14
      ...
      {:gettext, github: "elixir-gettext/gettext", tag: "v0.24.0", override: true},
      ...
      {:expo, github: "elixir-gettext/expo", tag: "v0.5.2", override: true},
